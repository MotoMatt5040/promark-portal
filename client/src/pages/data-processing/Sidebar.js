            ...
            <ul>
              <li className={activeSection === "uncle-setup/options" ? "step 8-1 --active" : "step 8-1"} onClick={(event) => handleNestedSectionClick("uncle-setup/options", event)}>
                ...
                <ul>
                  ...
                  <li className={activeSection === "uncle-setup/options/create-uncle-file" ? "step 8-1-2 --active" : "step 8-1-2"} onClick={(event) => handleNestedSectionClick("uncle-setup/options/create-uncle-file", event)}>Create Uncle File</li>
                </ul>
              </li>
